...
public class E03CharBooleanType {
	...
	public static void main(String[] args) 
	{
		...
		/*
		아스키코드 :1byte로 표현할수 있는 문자(영문, 숫자)
			정의한것을 말한다.
			Ex) A => 65로 표현됨. a => 97로 표현됨.
			
		유니코드 : 1byte로 표현할 수 없는 문자(한글, 한자, 일본어 등)을
		...
		char ch3 = (char)(ch2+num1); // (char형변환)(char+int=>int) => char
		System.out.println("ch3(문자출력)=>"+ ch3); //C 출력됨
		System.out.println("ch3(아스키코드출력)=>"+ (int)num2);
		
		char ch4 = '1'; //싱글쿼테이션을 감쌌으므로 문자1이 할당됨
		char ch4_1 = '1' +1;
